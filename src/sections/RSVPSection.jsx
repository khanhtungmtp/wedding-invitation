...
if (name.length > 50) {
errors.fullName = 'Họ tên tối đa 50 ký tự'
}

const phone = form.phone.trim()

const phoneRegex =
  /^(?:\+84|0)(3[2-9]|5[6|8|9]|7[0|6-9]|8[1-5|8|9]|9[0-9])[0-9]{7}$/;
...
if (msg.length > 300) {
errors.message = 'Lời chúc tối đa 300 ký tự'
}
...
console.log("PAYLOAD SEND:", payload);
  ...
  toast.error(
    err?.message ||
    'Gửi RSVP thất bại — thử lại sau nhé'
  )
...
return ( <section
 ...
 > <div
     className="glow-orb bg-blush-200/45"
     aria-hidden
   />
    ...
    <Reveal delay={0.06}>
      ...
      >
        ...
        >
          <div>
            <label
              className="text-xs font-semibold text-blush-muted"
              htmlFor="fullName"
            >
              Họ và tên
            </label>
            ...
            {errors.fullName ? (
              <p className="mt-2 text-sm font-semibold text-red-600/85">
                {errors.fullName}
              </p>
            ) : null}
          </div>
          ...
          <div>
            <p className="text-xs font-semibold text-blush-muted">
              Trạng thái
            </p>
            ...
            <p className="mt-3 text-xs font-semibold text-blush-muted">
              {attendingLabel}
            </p>
          ...
          <div>
            ...
            <div className="mt-2 flex items-center justify-between">
              {errors.message ? (
                <p className="text-sm font-semibold text-red-600/85">
                  {errors.message}
                </p>
              ) : (
                <span />
